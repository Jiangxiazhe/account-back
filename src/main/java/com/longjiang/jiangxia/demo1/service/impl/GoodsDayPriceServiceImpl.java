...
/**
* @author 78498
* @description 针对表【goods_day_price】的数据库操作Service实现
* @createDate 2022-07-30 16:27:09
*/
@Service
public class GoodsDayPriceServiceImpl extends ServiceImpl<GoodsDayPriceMapper, GoodsDayPrice>
    implements GoodsDayPriceService{
